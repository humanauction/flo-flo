...
def create_generator_agent() -> AssistantAgent:
    ...
    def generate_fake_headlines(count: int = 5) -> str:
        ...
        try:
            logger.info(f"🤖 Generating {count} fake headlines...")
            ...
            templates = [
                ...
                "from bakery window",
                "Florida man tries to pay bail with stack of expired Taco "
                "Bell coupons",
            ...
            logger.error(f"Generator tool failed: {e}", exc_info=True)
